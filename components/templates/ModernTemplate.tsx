    ...
    <>
      ...
      {data.keyAchievements && (
        <section className="mb-8 break-inside-avoid">
            <h2 className="text-xl font-bold uppercase tracking-wider border-b border-gray-300 pb-2 mb-4">Key Achievements</h2>
      ...
      {data.experience.map((exp) => (
        <div key={exp.id} className="mb-6 break-inside-avoid">
          ...
          <div className="text-gray-600 leading-relaxed whitespace-pre-line pl-4 border-l-2 border-gray-200">
            {exp.description}
          </div>
        </div>
      ))}

      <h2 className="text-xl font-bold uppercase tracking-wider border-b border-gray-300 pb-2 mb-4 mt-2">Education & Certifications</h2>
